  ...
  return (
    <div className='App pt-16 pb-16 mx-5 '>
      ...
      <div className='box-border m-auto max-w-[75rem] 3xl:max-w-[105rem] columns-1xs sm:columns-2xs md:columns-2 lg:columns-3 xl:columns-4 2xl:columns-4 3xl:columns-4'>
        ...
        {/** Card */}
        <article className='mb-4 break-inside p-6 rounded-xl flex flex-col bg-white dark:bg-slate-800 dark:text-white'>
          ...
          <div className='py-4'>
            <a className='inline-flex items-center' href='#'>
              <span className='mr-2'>
                <svg className='fill-rose-600 dark:fill-rose-400' width='24' height='24' viewBox='0 0 24 24'>
                  <path
          ...
          <div className='relative'>
            ...
            <span className='flex absolute right-3 top-2/4 -mt-3 items-center'>
              <svg className='mr-2' width='26' height='26' viewBox='0 0 24 24'>
                <path
                  fill='currentColor'
                  d='M20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12M22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12M10,9.5C10,10.3 9.3,11 8.5,11C7.7,11 7,10.3 7,9.5C7,8.7 7.7,8 8.5,8C9.3,8 10,8.7 10,9.5M17,9.5C17,10.3 16.3,11 15.5,11C14.7,11 14,10.3 14,9.5C14,8.7 14.7,8 15.5,8C16.3,8 17,8.7 17,9.5M12,17.23C10.25,17.23 8.71,16.5 7.81,15.42L9.23,14C9.68,14.72 10.75,15.23 12,15.23C13.25,15.23 14.32,14.72 14.77,14L16.19,15.42C15.29,16.5 13.75,17.23 12,17.23Z'
                />
              </svg>
              <svg className='fill-blue-500 dark:fill-slate-50' width='24' height='24' viewBox='0 0 24 24'>
              ...
              <div className='media-body'>
                ...
                <div className='mt-2 flex items-center'>
                  <a className='inline-flex items-center py-2 mr-3' href='#'>
                    <span className='mr-2'>
                      <svg
                        className='fill-rose-600 dark:fill-rose-400' width='22' height='22'
                        viewBox='0 0 24 24'
                      >
                        <path
                          d='M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z'
        ...
        <article className='mb-4 break-inside p-6 rounded-xl bg-white dark:bg-slate-800 flex flex-col bg-clip-border'>
          <div className='flex pb-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='inline-block text-lg font-bold mr-2' href='#'>Leonard Isom</a>
                </div>
                <div className='text-slate-500 dark:text-slate-300'>
                  Medical Assistant
                </div>
              ...
              <div className='media-body'>
                ...
                <div className='mt-4'>
                  <div className='media flex pb-4'>
                    ...
                    <div className='media-body'>
                      <div>
                        <a className='inline-block text-base font-bold mr-2' href='#'>Joseph Diaz</a>
                        <span className='text-slate-500 dark:text-slate-300'>5 minutes ago</span>
                      </div>
        ...
        <article className='mb-4 break-inside rounded-xl bg-white dark:bg-slate-800 flex flex-col bg-clip-border'>
          <div className='flex p-6 items-center justify-between'>
            <div className='flex'>
              <a className='inline-block mr-4' href='#'>
                <img className='rounded-full max-w-none w-14 h-14' src='https://randomuser.me/api/portraits/women/67.jpg' />
              </a>
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='inline-block text-lg font-bold mr-2' href='#'>Marylin B. Bechtol</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
                <div className='text-slate-500 dark:text-slate-300'>
