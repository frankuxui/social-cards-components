    ...
    <div className='App pt-16 pb-16 mx-5 '>
      ...
      <div className='box-border m-auto max-w-[75rem] 3xl:max-w-[120rem] columns-1xs sm:columns-2xs md:columns-2 lg:columns-3 xl:columns-3 2xl:columns-3 3xl:columns-5'>
        ...
        <article className='mb-4 break-inside p-6 rounded-xl flex flex-col text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-start justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div>
                  <a className='inline-block text-base font-bold' href='#'>Wade Warren</a>
                </div>
          ...
          <h2 className='text-xl font-extrabold'> Multiple web Design templates Selection </h2>
          <div className='py-4'>
          ...
          <div className='py-4'>
            <a className='inline-flex items-center' href='#'>
              <span className='mr-2'>
                <svg className='fill-rose-600 dark:fill-rose-400' width='18' height='18' viewBox='0 0 24 24'>
                  <path
          ...
          <div className='pt-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Camila Gomez</a>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Xavi Jimenez</a>
            ...
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='inline-block text-base font-bold mr-2' href='#'>Esther Howard</a>
                  <span>
                    <svg className='fill-blue-500 dark:fill-slate-50' width='18' height='18' viewBox='0 0 24 24'>
                      <path
          ...
          <div className='pt-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Felippe Diogo</a>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Jessica</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
        ...
        <article className='flex flex-col bg-clip-border mb-4 break-inside p-6 rounded-xl text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='inline-block text-base font-bold mr-2' href='#'>Leonard Palenko</a>
                </div>
        ...
        <article className='mb-4 break-inside p-6 rounded-xl text-sm flex flex-col bg-clip-border bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Eduardo</a>
          ...
          <div className='pt-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Shawn</a>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Dianne Russell</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
        ...
        <article className='mb-4 break-inside p-6 rounded-xl flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Anna Bernal</a>
          ...
          <div className='pt-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Kristinne</a>
                  <span className='text-slate-500 dark:text-slate-300'>2 days ago</span>
                </div>
                <p className='text-sm'> Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod. </p>
                <div className='mt-2 flex items-center'>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Eleanor Pena</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
                <p> Dolor sit ameteiusmod Dolor sit ameteiusmod 😍😍✌🤪consectetur adipiscing elitconsectetur adipiscing elit. </p>
                <div className='mt-2 flex items-center'>
                  <a className='inline-flex items-center py-2 mr-3' href='#'>
                    <span className='mr-2'>
                      <svg className='fill-rose-600 dark:fill-rose-400' width='18' height='18' viewBox='0 0 24 24'>
                ...
                <div className='mt-4'>
                  <div className='flex pb-4'>
                    ...
                    <div className='flex-1 relative pr-10'>
                      ...
                      <div>
                        <a className='inline-block font-bold mr-2' href='#'>Joseph</a>
                        <span className='text-slate-500 dark:text-slate-300'>Just now</span>
                      </div>
                      <p className='text-sm'>Dolor sit ate iusmod con sectetur.</p>
                      <div className='mt-2 flex items-center'>
                        <a className='inline-flex items-center py-2 mr-3' href='#'>
                          <span className='mr-2'>
                            <svg className='fill-rose-600 dark:fill-rose-400' width='18' height='18' viewBox='0 0 24 24'>
        ...
        <article className='mb-4 break-inside p-6 rounded-xl flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Savannah Nguyen</a>
                </div>
                <div className='text-slate-500 dark:text-slate-300'> January 22, 2021 </div>
              </div>
            </div>
        ...
        <article className='mb-4 break-inside rounded-xl flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex p-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Annette Black</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
        ...
        <article className='mb-4 break-inside rounded-xl flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex p-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Cameron Williamson</a>
                  <span>
          ...
          <div className='p-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Kristin Watson</a>
                  <span className='text-slate-500 dark:text-slate-300'>25 minutes ago</span>
                </div>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Melvin D. Goodman</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
                <p className='text-sm'>Dolor sit ameteiusmod consectetur adipiscing elit.</p>
                <div className='mt-2 flex items-center'>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Erik Moore</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
        ...
        <article className='mb-4 break-inside rounded-xl flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex p-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Marylin Betancourt</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
              ...
              <a className='inline-flex items-center' href='#'>
                ...
                <span className='-m-1 rounded-full border-2 border-white dark:border-slate-800'>
                  <svg xmlns='http://www.w3.org/2000/svg' width='22' height='22' fill='none' viewBox='0 0 16 16'>
                    <g clipPath='url(#a21)'>
                      <path fill='url(#b21)' d='M16 8A8 8 0 1 1-.001 8 8 8 0 0 1 16 8' />
                      <path fill='url(#c21)' d='M5.643 10.888C5.485 12.733 6.37 14 8 14c1.63 0 2.515-1.267 2.357-3.112C10.2 9.042 9.242 8 8 8c-1.242 0-2.2 1.042-2.357 2.888Z' />
                      <path fill='url(#d21)' d='M3.5 5.5c0-.828.559-1.5 1.25-1.5S6 4.672 6 5.5C6 6.329 5.441 7 4.75 7S3.5 6.329 3.5 5.5Zm6.5 0c0-.828.56-1.5 1.25-1.5.691 0 1.25.672 1.25 1.5 0 .829-.559 1.5-1.25 1.5C10.56 7 10 6.329 10 5.5Z' />
                      <path fill='#000' d='M3.5 5.5c0-.828.559-1.5 1.25-1.5S6 4.672 6 5.5C6 6.329 5.441 7 4.75 7S3.5 6.329 3.5 5.5Zm6.5 0c0-.828.56-1.5 1.25-1.5.691 0 1.25.672 1.25 1.5 0 .829-.559 1.5-1.25 1.5C10.56 7 10 6.329 10 5.5Z' filter='url(#e21)' />
                      <path fill='#4E506A' d='M4.481 4.567c.186.042.29.252.232.47-.057.217-.254.36-.44.317-.186-.042-.29-.252-.232-.47.057-.216.254-.36.44-.317Zm6.659.063c.205.047.321.28.258.52-.064.243-.282.4-.49.354-.205-.046-.322-.28-.258-.52.063-.243.282-.4.49-.354Z' />
                      <path fill='#000' d='M11.068 1.696c.052-.005.104-.007.157-.007.487 0 .99.204 1.372.562a.368.368 0 0 1-.087.594.344.344 0 0 1-.387-.06c-.275-.26-.656-.4-.992-.37a.8.8 0 0 0-.59.332.346.346 0 0 1-.49.068.368.368 0 0 1-.068-.507 1.49 1.49 0 0 1 1.085-.612Zm-7.665.555c.371-.353.86-.553 1.372-.562a1.49 1.49 0 0 1 1.242.619.369.369 0 0 1-.066.507.347.347 0 0 1-.492-.068.8.8 0 0 0-.59-.331c-.335-.031-.717.11-.992.369a.344.344 0 0 1-.496-.024.368.368 0 0 1 .022-.51Z' filter='url(#f21)' />
                      <path fill='url(#g21)' d='M11.068 1.696c.052-.005.104-.007.157-.007.487 0 .99.204 1.372.562a.368.368 0 0 1-.087.594.344.344 0 0 1-.387-.06c-.275-.26-.656-.4-.992-.37a.8.8 0 0 0-.59.332.346.346 0 0 1-.49.068.368.368 0 0 1-.068-.507 1.49 1.49 0 0 1 1.085-.612Zm-7.665.555c.371-.353.86-.553 1.372-.562a1.49 1.49 0 0 1 1.242.619.369.369 0 0 1-.066.507.347.347 0 0 1-.492-.068.8.8 0 0 0-.59-.331c-.335-.031-.717.11-.992.369a.344.344 0 0 1-.496-.024.368.368 0 0 1 .022-.51Z' />
                    </g>
                    <defs>
                      <linearGradient id='b21' x1='8' x2='8' y1='1.64' y2='16' gradientUnits='userSpaceOnUse'>
                        <stop stopColor='#FEEA70' />
                        <stop offset='1' stopColor='#F69B30' />
                      </linearGradient>
                      <linearGradient id='c21' x1='8' x2='8' y1='8' y2='14' gradientUnits='userSpaceOnUse'>
                        <stop stopColor='#472315' />
                        <stop offset='1' stopColor='#8B3A0E' />
                      </linearGradient>
                      <linearGradient id='d21' x1='8' x2='8' y1='4' y2='7' gradientUnits='userSpaceOnUse'>
                        <stop stopColor='#191A33' />
                        <stop offset='.872' stopColor='#3B426A' />
                      </linearGradient>
                      <linearGradient id='g21' x1='8' x2='8' y1='1.688' y2='2.888' gradientUnits='userSpaceOnUse'>
                        <stop stopColor='#E78E0D' />
                        <stop offset='1' stopColor='#CB6000' />
                      </linearGradient>
                      <filter id='e21' width='9' height='3' x='3.5' y='4' colorInterpolationFilters='sRGB' filterUnits='userSpaceOnUse'>
                      ...
                      <filter id='f21' width='15.422' height='7.199' x='.289' y='-.312' colorInterpolationFilters='sRGB' filterUnits='userSpaceOnUse'>
                        <feFlood floodOpacity='0' result='BackgroundImageFix' />
        ...
        <article className='mb-4 break-inside p-6 rounded-xl flex flex-col text-sm group bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Alexander Mitrovic</a>
                  <span>
                    <svg className='fill-blue-500 dark:fill-slate-50' width='18' height='18' viewBox='0 0 24 24'>
                      <path
                        d='M10,17L5,12L6.41,10.58L10,14.17L17.59,6.58L19,8M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z'
          ...
          <div className='pt-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Ronald Richards</a>
                  <span className='text-slate-500 dark:text-slate-300'>25 minutes ago</span>
                </div>
                <p className='text-sm'> Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod 😀😀😀 </p>
                <div className='mt-2 flex items-center'>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Natalia Jímenez</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
                <p className='text-sm'>Dolor sit ameteiusmod consectetur adipiscing elit.</p>
                <div className='mt-2 flex items-center'>
            ...
            <div className='rounded-xl border border-slate-200 dark:border-slate-700'>
              <div className='flex p-6 items-center justify-between'>
                <div className='flex'>
                  ...
                  <div className='flex flex-col'>
                    <div className='flex items-center'>
                      <a className='text-base font-bold mr-2' href='#'>Paula Lopez</a>
                    </div>
                    <div className='text-sm text-slate-500 dark:text-slate-300'>
                      Marketing Coordinator
                    </div>
        ...
        <article className='mb-4 break-inside p-6 rounded-xl flex flex-col text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex pb-6 items-start justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div>
                  <a className='inline-block text-base font-bold' href='#'>Thomas Frank</a>
                </div>
          ...
          <h2 className='text-xl font-extrabold'> Multiple Multiple web Design templates Selection </h2>
          ...
          <div className='pt-6'>
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Leslie Alexander</a>
                  <span className='text-slate-500 dark:text-slate-300'>25 minutes ago</span>
                </div>
                <p className='text-sm'>Lorem ipsum dolor sit amet, consectetur.</p>
                <div className='mt-2 flex items-center'>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Tina Mills</a>
                  <span className='text-slate-500 dark:text-slate-300'>3 minutes ago</span>
                </div>
                <p className='text-sm'>Dolor sit ameteiusmod consectetur adipiscing elit permiaso olcanc.</p>
                <div className='mt-2 flex items-center'>
        ...
        <article className='mb-4 break-inside rounded-xl flex flex-col bg-clip-border text-sm py-6 space-y-6 bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex px-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Esthel Maria</a>
          ...
          <div className='px-6 space-y-4'>
            <h4 className='mb-2 text-xl font-extrabold leading-snug'>International exhibition of free photography</h4>
        ...
        <article className='mb-4 space-y-6 pb-6 break-inside rounded-xl overflow-hidden flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='p-6 space-y-2 bg-slate-50 dark:bg-slate-700 text-slate-500 dark:text-slate-400'>
            <h5 className='font-bold text-base text-black dark:text-white'>Congratulations</h5>
            <p>Congratulations to
              <a href='#' className='font-medium'> Marina Valdez </a>
              and
              <a href='#' className='font-medium'> Alexander Oliver </a>
          ...
          <div className='flex px-6 flex-col space-y-6 text-center'>
            <div className='flex items-center justify-between'>
              <a className='inline-block mr-4' href='#'>
                <img className='rounded-full max-w-none w-14 h-14' src='https://randomuser.me/api/portraits/women/24.jpg' alt='Avatar' />
              </a>
              <span className='w-16 h-16 flex items-center justify-center rounded-full bg-yellow-100 dark:bg-slate-700'>
                <svg xmlns='http://www.w3.org/2000/svg' enableBackground='new 0 0 47.5 47.5' viewBox='0 0 47.5 47.5' width='50' height='50'>
                  <defs>
                    <clipPath id='a'>
          ...
          <div className='px-6 space-y-6'>
            ...
            <div className='flex pb-4 group'>
              ...
              <div className='flex-1 relative pr-10'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>José Lody</a>
                  <span className='text-slate-500 dark:text-slate-300'>03 minutes ago</span>
                </div>
                <p className='text-sm'> Congratulations on such a sincere friendship 😍😍😍</p>
                <div className='mt-2 flex items-center'>
                  <a className='inline-flex items-center py-2 mr-3' href='#'>
                    <span className='mr-2'>
                      <svg className='fill-rose-600 dark:fill-rose-400' width='18' height='18' viewBox='0 0 24 24'>
        ...
        <article className='mb-4 space-y-6 pb-6 pt-6 break-inside rounded-xl overflow-hidden flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex px-6 items-center justify-between'>
            <div className='flex'>
              <a className='inline-block mr-4' href='#'>
                <span className='flex items-center justify-center rounded-full max-w-none w-12 h-12 text-xl font-bold text-white bg-[#00c9a9]'>M</span>
              </a>
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Music companny</a>
                </div>
                <div className='text-sm text-slate-500 dark:text-slate-300'> Has shared the following event </div>
              </div>
            </div>
          </div>
          <div className='flex relative flex-col justify-between'>
            ...
            <img src='https://images.pexels.com/photos/2787341/pexels-photo-2787341.jpeg?cs=srgb&dl=pexels-ali-pazani-2787341.jpg&fm=jpg' alt='cover' className='object-cover' />
          </div>
          <div className='px-6 flex justify-between items-center'>
            <a className='inline-flex items-center' href='#'>
              <span className='-m-1 rounded-full border-2 border-white dark:border-slate-800'>
          ...
          <div className='px-6 space-y-6'>
            ...
            <div className='flex pb-4 group'>
              <a className='mr-4' href='#'>
                <img className='rounded-full max-w-none w-11 h-11' src='https://randomuser.me/api/portraits/men/62.jpg' alt='Avatar' />
              </a>
              <div className='flex-1 relative pr-10'>
                <button className='hidden absolute right-0 top-0 group-hover:flex items-center justify-center rounded-full p-1 transition-all hover:bg-slate-200 dark:hover:bg-slate-700 '>
                  <svg width='22' height='22' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div>
                  <a className='inline-block font-bold mr-2' href='#'>Fabian Ruiz</a>
                  <span className='text-slate-500 dark:text-slate-300'>03 minutes ago</span>
                </div>
                <p className='text-sm'> Please someone tell me the price of the tickets 🙏🙏🙏</p>
                <div className='mt-2 flex items-center'>
                  <a className='inline-flex items-center py-2 mr-3' href='#'>
                    <span className='mr-2'>
                      <svg className='fill-rose-600 dark:fill-rose-400' width='18' height='18' viewBox='0 0 24 24'>
        ...
        <article className='break-inside relative flex flex-col justify-between overflow-hidden rounded-xl mb-4 text-sm bg-white dark:bg-slate-800 dark:text-slate-50'>
          ...
          <div className='p-4 space-y-4'>
            ...
            <div className='pt-6'>
              <div className='flex pb-4 group'>
                <a className='mr-4' href='#'>
                  <img className='rounded-full max-w-none w-11 h-11' src='https://randomuser.me/api/portraits/men/10.jpg' alt='Avatar' />
                </a>
                <div className='flex-1 relative pr-10'>
                  <button className='hidden absolute right-0 top-0 group-hover:flex items-center justify-center rounded-full p-1 transition-all hover:bg-slate-200 dark:hover:bg-slate-700 '>
                    <svg width='22' height='22' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <div>
                    <a className='inline-block font-bold mr-2' href='#'>Jhon Fernandez</a>
              ...
              <div className='flex pb-4 group'>
                <a className='inline-block mr-4' href='#'>
                  <img className='rounded-full max-w-none w-11 h-11' src='https://randomuser.me/api/portraits/women/75.jpg' alt='Avatar' />
                </a>
                <div className='flex-1 relative pr-10'>
                  <button className='hidden absolute right-0 top-0 group-hover:flex items-center justify-center rounded-full p-1 transition-all hover:bg-slate-200 dark:hover:bg-slate-700 '>
                    <svg width='22' height='22' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                  ...
                  <div>
                    <a className='inline-block font-bold mr-2' href='#'>Alexandra</a>
        ...
        <article className='mb-4 py-6 space-y-6 break-inside rounded-xl flex flex-col bg-clip-border text-sm bg-white dark:bg-slate-800 dark:text-white'>
          <div className='flex px-6 items-center justify-between'>
            <div className='flex'>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center'>
                  <a className='text-base font-bold mr-2' href='#'>Alicia Gasperinni</a>
                  <span className=''>
          ...
          <div className='relative'>
            <img src='https://images.pexels.com/photos/534362/pexels-photo-534362.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' className='w-full object-cover min-h-[22rem]' alt='Image' />
